...
typedef enum _tag_FuncEnum
{
    ...
    E_SetEvent,
    E_ResetEvent,
    E_InitializeCriticalSection,
    E_EnterCriticalSection,
    E_LeaveCriticalSection,
    E_InitializeCriticalSectionAndSpinCount,
    E_InitializeCriticalSectionEx,
    E_SetCriticalSectionSpinCount,
    E_TryEnterCriticalSection,
    E_DeleteCriticalSection,
    E_WaitForSingleObject,
    E_WaitForSingleObjectEx,
    E_WaitForMultipleObjectsEx,
    E_SleepEx,
    // stdio.h
    E_fopen,
    E__wfopen,
